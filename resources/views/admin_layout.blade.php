			    ...
			    <ul class="nav pull-right top-menu">
			        ...
			        <li class="dropdown">
			            <a style="padding: 4px" data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0)">
			                <i class="fa fa-credit-card-alt" style="padding-left: 10px;"></i>
		    ...
		    <div id="sidebar" class="nav-collapse">
		        ...
		        <div class="leftside-navigation">
		            <ul class="sidebar-menu" id="nav-accordion">
		                <li class="sub-menu">
		                    <a class="active" href="{{ route('b1.index')}}">
		                        <i class="fa fa-thumbs-up"></i>
		                        <span>Xem thông tin dự án</span>
		                    </a>
		                </li>
		                
		                <li class="sub-menu">
		                    <a href="{{ route('b2.index')}} ">
		                        <i class="fa fa-thumbs-up"></i>
		                        <span>Xem lương nhân viên</span>
		                    </a>
		                </li>
		                <li class="sub-menu">
		                    <a href="{{ route('b3.index')}}">
		                        <i class="fa fa-thumbs-up"></i>
		                        <span>Thêm nhân viên</span>
		                    </a>
		                </li>
		                <li class="sub-menu">
		                    <a href="{{ route('b4.index')}}">
		                        <i class="fa fa-thumbs-up"></i>
		...
		<section id="main-content">
		 ...
		 <!-- footer -->
				  <div style="background: #D6D6D0;padding-top: 10px;position: fixed;bottom: 0;width: 100%;" class="footer-bottom">
		            <div class="container">
		                <div class="row">
		                    <p class="pull-left">Copyright <i class="fa fa-youtube-play"></i> -> HieuTutorial. All rights reserved.</p>
