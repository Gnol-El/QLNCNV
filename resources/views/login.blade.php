...
<link href="{{asset('public/fontend/css/style-responsive.css')}}" rel="stylesheet"/>
<!-- font CSS -->
...
<script src="{{asset('public/fontend/js/bootstrap.js')}}"></script>
<script src="{{asset('public/fontend/js/jquery.dcjqaccordion.2.7.js')}}"></script>
<script src="{{asset('public/fontend/js/scripts.js')}}"></script>
<script src="{{asset('public/fontend/js/jquery.slimscroll.js')}}"></script>
<script src="{{asset('public/fontend/js/jquery.nicescroll.js')}}"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="{{asset('public/fontend/js/jquery.scrollTo.js')}}"></script>
</body>
</html>
